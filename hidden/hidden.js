...
async function onHide() {
  ...
  try {
    ...
    error("The hidden URL appears corrupted. It must be a password-protected Link Lock URL. <a href=\"https://link-lock.theanimecentreindia.tech\">Click here to add a password.</a>");
    return;
...
function main() {
  if (window.location.hash) {
    document.querySelector("#encrypted-url").value =
      `https://link-lock.theanimecentreindia.tech${window.location.hash}`;
